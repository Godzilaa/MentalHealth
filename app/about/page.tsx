export default function About() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">About AI Health Companion</h1>
      <p className="mb-4">
        AI Health Companion is a cutting-edge platform that combines artificial intelligence with health and wellness monitoring to provide personalized care and support.
      </p>
      <p className="mb-4">
